...
#if 0
// 1adv(2node)
static xJson::Value get_system_topology_xsync_020() {
    ...
    v["node"]["node0"]["parent"] = "adv0";
    v["node"]["node1"]["parent"] = "adv0";

    return v;
}

// 1arc(1node)
static xJson::Value get_system_topology_xsync_100() {
...
// 1arc(2node)
static xJson::Value get_system_topology_xsync_200() {
...
// 1adv(2node) + 1 archive(2node)
static xJson::Value get_system_topology_xsync_220() {
...
// 1adv(2node) + 1shard(2node)
static xJson::Value get_system_topology_xsync_022() {
...
// 1adv(2node) + 1shard(2node) + 1 archive(2node)
static xJson::Value get_system_topology_xsync_222() {
    ...
    v["node"]["node0"]["parent"] = "shard0";
    v["node"]["node1"]["parent"] = "shard0";
    v["node"]["node2"]["parent"] = "adv0";
    v["node"]["node3"]["parent"] = "adv0";
    v["node"]["node4"]["parent"] = "arc0";
    v["node"]["node5"]["parent"] = "arc0";
...
// 1adv(2node) + 1shard(3node)
static xJson::Value get_system_topology_consensus_simple() {
    ...
    v["node"]["node3"]["parent"] = "adv0";
    v["node"]["node4"]["parent"] = "adv0";

    return v;
}


// 2adv(2node) + 2shard(3node)
static xJson::Value get_system_topology_consensus_full() {
    ...
    v["group"]["adv1"]["type"] = "advance";
    v["group"]["adv1"]["parent"] = "zone0";

    v["group"]["shard0"]["type"] = "shard";
    v["group"]["shard0"]["parent"] = "adv0";

    v["group"]["shard1"]["type"] = "shard";
    v["group"]["shard1"]["parent"] = "adv1";

    v["node"]["node0"]["parent"] = "shard0";
    v["node"]["node1"]["parent"] = "shard0";
    v["node"]["node2"]["parent"] = "shard0";

    v["node"]["node3"]["parent"] = "shard1";
    v["node"]["node4"]["parent"] = "shard1";
    v["node"]["node5"]["parent"] = "shard1";

    v["node"]["node6"]["parent"] = "adv0";
    v["node"]["node7"]["parent"] = "adv0";

    v["node"]["node8"]["parent"] = "adv1";
    v["node"]["node9"]["parent"] = "adv1";

    return v;
}

// 1zec(2node)
static xJson::Value get_system_topology_xsync_zec_2node() {

    xJson::Value v = xJson::objectValue;

    v["group"]["zone0"]["type"] = "zone";

    v["group"]["zec"]["type"] = "zec";
    v["group"]["zec"]["parent"] = "zone0";

    v["node"]["node0"]["parent"] = "zec";
    v["node"]["node1"]["parent"] = "zec";
...
public:
    xmock_network_config_t(const std::string &name) {

        xJson::Value cfg_system_topology;

        if (name == "xsync_validator_behind") {
            cfg_system_topology = xsync_validator_behind();
        } else if (name == "xsync_broadcast") {
            cfg_system_topology = xsync_broadcast();
        } else if (name == "timercert") {
            cfg_system_topology = timercert();
        } else if (name == "xsync_latest") {
            cfg_system_topology = xsync_latest();
        } else {
            assert(0);
        }
