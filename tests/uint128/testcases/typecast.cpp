...
TEST(Typecast, all){
    const top::xstake::uint128_t val(0xaaaaaaaaaaaaaaaaULL, 0xaaaaaaaaaaaaaaaaULL);

    EXPECT_EQ(static_cast <bool>     (top::xstake::uint128_t(true)),          true);
    EXPECT_EQ(static_cast <bool>     (top::xstake::uint128_t(false)),         false);
