...
DEFINE_FUNC(archive, top::common::build_archive_sharding_address(top::common::xarchive_group_id, top::common::xbeacon_network_id))
...
common::xnode_address_t create_archive_addr(uint16_t _slot_id, const std::string & name, std::size_t id) {
    ...
    // common::xnetwork_id_t nid{m_net_id++};
    common::xnetwork_id_t nid{1};
    auto const cluster_addr = common::build_archive_sharding_address(top::common::xarchive_group_id, nid);
