...
void test_xsync_chain_down::test_interval_no_blocks_in_span(uint64_t cp_start_height, uint64_t cp_end_height)
{
    ...
    std::cout << std::endl
              << " cp_start_height " << cp_start_height << " cp_end_height  " << cp_end_height << std::endl;
    ...
    std::cout << "pair_result.first   " << pair_result.first << " pair_result.second " << pair_result.second << std::endl;
...
void test_xsync_chain_down::test_interval_blocks_in_span(uint64_t cp_start_height, uint64_t cp_end_height, uint64_t check_start_height, uint64_t check_end_height)
{
    ...
    // no checkoutpoint data
    // uint64_t cp_height  = sync_store.get_latest_end_block_height(address, enum_chain_sync_policy_checkpoint);
    // std::cout << "cp_height "  << cp_height << "  cp_start_height " << cp_start_height << " cp_end_height  " << cp_end_height << " check_start_height " << check_start_height << " check_end_height " << check_end_height << std::endl;
...
TEST_F(test_xsync_chain_down, test_xsync_0_50_70_test)
{
    save_block(1, 77);
...
TEST_F(test_xsync_chain_down, test_xsync_0_77_79_100_test)
{
    save_block(1, 80);
    test_interval_blocks_in_span(1, 70, 0, 0);
...
TEST_F(test_xsync_chain_down, test_xsync_0_80_80_100_test)
{
    save_block(1, 80);
    save_block(90, 100);
