...
TEST(compatibility, election_info) {
    {
        data::election::xelection_info_t from;
        ...
        auto const from_bytes = codec::xmsgpack_codec_t<data::election::xelection_info_t>::encode(from);
        auto const to = codec::xmsgpack_codec_t<data::election::legacy::xelection_info_t>::decode(from_bytes);
        ...
        ASSERT_EQ(to, from.legacy());

        auto const to_bytes = codec::xmsgpack_codec_t<data::election::legacy::xelection_info_t>::encode(to);
        auto const from_again = codec::xmsgpack_codec_t<data::election::xelection_info_t>::decode(to_bytes);
    ...
    {
        data::election::legacy::xelection_info_t from;
        from.comprehensive_stake = 42;
        from.consensus_public_key = top::xpublic_key_t{"faked public key"};
        from.joined_version = common::xelection_round_t{24};
        from.stake = 4242;

        auto const from_bytes = codec::xmsgpack_codec_t<data::election::legacy::xelection_info_t>::encode(from);
        auto const to = codec::xmsgpack_codec_t<data::election::xelection_info_t>::decode(from_bytes);
        ...
        auto const to_bytes = codec::xmsgpack_codec_t<data::election::xelection_info_t>::encode(to);
        auto const from_again = codec::xmsgpack_codec_t<data::election::legacy::xelection_info_t>::decode(to_bytes);
...
TEST(compatibility, standby_node_info) {
    {
        data::election::xstandby_node_info_t from;
        ...
        auto const from_bytes = codec::xmsgpack_codec_t<data::election::xstandby_node_info_t>::encode(from);
        auto const to = codec::xmsgpack_codec_t<data::election::legacy::xstandby_node_info_t>::decode(from_bytes);
        ...
        auto const to_bytes = codec::xmsgpack_codec_t<data::election::legacy::xstandby_node_info_t>::encode(to);
        auto const from_again = codec::xmsgpack_codec_t<data::election::xstandby_node_info_t>::decode(to_bytes);
    ...
    {
        data::election::legacy::xstandby_node_info_t from;
        from.consensus_public_key = xpublic_key_t{"fake"};
        from.genesis = true;
#if defined(XENABLE_MOCK_ZEC_STAKE)
        from.miner_type = common::xminer_type_t::edge | common::xminer_type_t::validator;
        ...
        auto const from_bytes = codec::xmsgpack_codec_t<data::election::legacy::xstandby_node_info_t>::encode(from);
        auto const to = codec::xmsgpack_codec_t<data::election::xstandby_node_info_t>::decode(from_bytes);
        ...
        auto const to_bytes = codec::xmsgpack_codec_t<data::election::xstandby_node_info_t>::encode(to);
        auto const from_again = codec::xmsgpack_codec_t<data::election::legacy::xstandby_node_info_t>::decode(to_bytes);
