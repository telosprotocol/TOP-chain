...
TEST(data_structures_test, xunqualified_node_info) {
    ...
    e2.block_count = 30;
    e2.subset_count = 60;
    i_v2.evm_auditor_info[common::xnode_id_t{"T00000LNomDyH8kN2zQhexGbg4dMJY1ZbAAekZ8Y"}] = e1;
    i_v2.evm_auditor_info[common::xnode_id_t{"T00000LcYvxYB3EAnPcBo9hPybrDM2ZB5v5JFcyg"}] = e2;
    ...
    EXPECT_EQ(i_v2_new.evm_auditor_info.size(), 0);
