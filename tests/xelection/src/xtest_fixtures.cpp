...
xtop_committee_fixure::SetUp() {
    ...
    m_election_cache_data_accessor =
        top::make_unique<top::election::cache::xdata_accessor_t>(network_id,
                                                                 top::make_observer(top::tests::election::xdummy_chain_timer));
...
void
xtop_committee_fixure::TearDown() {
    m_election_cache_data_accessor.reset();
}

void
xtop_zec_fixture::SetUp() {
...
void
xtop_zec_fixture::TearDown() {
    m_election_cache_data_accessor.reset();
}

void
xtop_edge_fixture::SetUp() {
    top::common::xnetwork_id_t network_id{ top::common::xtopchain_network_id };
...
void
xtop_edge_fixture::TearDown() {
    m_election_cache_data_accessor.reset();
}

void
xtop_archive_fixture::SetUp() {
    top::common::xnetwork_id_t network_id{ top::common::xtopchain_network_id };
...
void
xtop_archive_fixture::TearDown() {
    m_election_cache_data_accessor.reset();
}

void
xtop_consensus_fixture::SetUp() {
    top::common::xnetwork_id_t network_id{ top::common::xtopchain_network_id };
...
void
xtop_consensus_fixture::TearDown() {
    m_election_cache_data_accessor.reset();
}
