...
TEST_F(xtest_zec_workload_contract_new_t, test_handle_workload_str) {
...
TEST_F(xtest_zec_workload_contract_new_t, upload_workload_internal) {
    std::string str{};
    std::map<std::string, std::string> workload;
    m_workload_contract.upload_workload_internal(100, workload, str);
    ...
    }
    {
        ...
        workload[group_address_str] = value_str;
    }
...
TEST_F(xtest_zec_workload_contract_new_t, test_handle_workload_str_multi_thread_time_BENCH) {
...
TEST_F(xtest_zec_workload_contract_new_t, test_handle_workload_str_time_BENCH) {
    uint64_t time_total = 0;
    uint64_t second = 1;
