...
bool xtop_test_registration_data_manager_fixture::add_reg_info(xstake::xreg_node_info const & node_info) {
    return m_registration_data.insert({common::xnode_id_t{node_info.m_account}, node_info}).second;
}

bool xtop_test_registration_data_manager_fixture::update_reg_info(xstake::xreg_node_info const & node_info) {
