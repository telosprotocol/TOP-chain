...
TEST(xtop_router, address_of_book_id) {
    ...
    for (auto i = 0u; i < 128u; ++i) {
        ...
        auto const archive_address = router->address_of_book_id(static_cast<std::uint16_t>(i), top::common::xnode_type_t::full_archive, top::common::xtopchain_network_id);
        ...
        EXPECT_EQ(top::common::build_zec_sharding_address(top::common::xtopchain_network_id), zec_address);
