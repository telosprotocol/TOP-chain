...
class xtop_chain_application : public xapplication_face_t<xtop_chain_application> {
private:
    using xbase_t = xapplication_face_t<xtop_chain_application>;

protected:
    observer_ptr<xapplication_t> m_application;  // top most application object. used to query node_id / public key etc....
    ...
    std::shared_ptr<xtxpool_service::xtxpool_service_mgr_face>  m_txpool_service_mgr;
    std::shared_ptr<vnode::xvnode_manager_face_t>               m_vnode_manager;

public:
    xtop_chain_application(xtop_chain_application const &) = delete;
    xtop_chain_application & operator=(xtop_chain_application const &) = delete;
    xtop_chain_application(xtop_chain_application &&) = default;
    xtop_chain_application & operator=(xtop_chain_application &&) = default;
    ~xtop_chain_application() override = default;
...
using xchain_application_t = xtop_chain_application;
