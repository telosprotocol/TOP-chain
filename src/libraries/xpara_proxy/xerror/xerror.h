...
template <>
struct hash<top::para_proxy::error::xerrc_t> final {
    size_t operator()(top::para_proxy::error::xerrc_t errc) const noexcept;
};

#endif

template <>
struct is_error_code_enum<top::para_proxy::error::xerrc_t> : std::true_type {
};

template <>
struct is_error_condition_enum<top::para_proxy::error::xerrc_t> : std::true_type {
};
