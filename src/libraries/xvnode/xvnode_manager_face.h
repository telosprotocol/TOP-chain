...
public:
    ...
    virtual std::vector<common::xip2_t> handle_election_data(std::unordered_map<common::xsharding_address_t, election::cache::xgroup_update_result_t> const & election_data) = 0;
