...
void xsync_chain_spans_t::save(){
    ...
    if (m_connect_to_genesis_height_modified) {
        ...
        xsync_dbg("xsync_store_shadow_t::save, account:%s, height=%llu",
...
void xsync_chain_spans_t::initialize() {
    ...
    xsync_dbg("xsync_store_shadow_t::initialize before, account:%s, height=%llu",
        m_account.c_str(), m_connect_to_genesis_height);
    ...
    xsync_info("xsync_store_shadow_t::initialize after, account:%s, new height=%llu, old height=%llu",
...
void xsync_store_shadow_t::xsync_event_cb(mbus::xevent_ptr_t e) {
    ...
    xsync_info("xsync_store_shadow_t::xsync_event_cb, account:%s, height=%llu",
...
void xsync_store_shadow_t::on_chain_event(const std::string &account, uint64_t height) {
    ...
    if (chain_spans != nullptr) {
        ...
        xsync_info("xsync_store_shadow_t::on_chain_event, account:%s, height=%llu",
