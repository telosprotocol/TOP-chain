...
xtop_sync_out_object * xtop_sync_out_object::__global_sync_out_instance = NULL;
xtop_sync_out_object& xtop_sync_out_object::instance() {
    if (__global_sync_out_instance != NULL)
        return *__global_sync_out_instance;

    __global_sync_out_instance = new xtop_sync_out_object();
    return *__global_sync_out_instance;
}
