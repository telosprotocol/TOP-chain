...
void xrole_chains_t::init_chains() {
    ...
    add_tables(nt::fullnode, sys_contract_beacon_table_block_addr, enum_chain_sync_policy_full);
    add_tables(nt::fullnode, sys_contract_zec_table_block_addr, enum_chain_sync_policy_full);
    add_tables(nt::fullnode, sys_contract_sharding_table_block_addr, enum_chain_sync_policy_full);
    add_chain(nt::fullnode, sys_drand_addr, enum_chain_sync_policy_full);
}
