...
void xsync_behind_checker_t::check_one(const std::string &address, enum_chain_sync_policy sync_policy, const vnetwork::xvnode_address_t &self_addr, const std::string &reason) {
    ...
    if (m_peerset->get_newest_peer(self_addr, address, peer_start_height, peer_end_height, peer_addr)) {
        ...
        if (sync_policy == enum_chain_sync_policy_fast) {
            peer_left_metric_tag_name = "xsync_max_peer_fast_interval_left" + address;
            peer_right_metric_tag_name = "xsync_max_peer_fast_interval_right" + address;
            self_left_metric_tag_name = "xsync_self_fast_interval_left" + address;
            self_right_metric_tag_name = "xsync_self_fast_interval_right" + address;
            self_full_block_state_metirc_tag_name = "xsync_self_fast_full_state" + address;
            ...
            peer_left_metric_tag_name = "xsync_max_peer_full_interval_left" + address;
            peer_right_metric_tag_name = "xsync_max_peer_full_interval_right" + address;
            self_left_metric_tag_name = "xsync_self_full_interval_left" + address;
            self_right_metric_tag_name = "xsync_self_full_interval_right" + address;
        }
