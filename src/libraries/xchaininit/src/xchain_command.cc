...
int parse_execute_command(const char * config_file_extra, int argc, char * argv[]) {
    ...
    */
    ...
    registerMiner_app->add_option("miner_type", miner_type, "Miner type: edge, validator, advance, archive, exchange.")->required();
    ...
    updateMinerInfo_app->add_option("miner_type", updateMinerInfo_type, "New miner type: edge, validator, advance, archive, exchange.")->required();
    ...
    changeMinerType_app->add_option("miner_type", changeMinerType_type, "New miner type: edge, validator, advance, archive, exchange.")->required();
