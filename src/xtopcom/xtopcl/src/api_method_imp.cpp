...
bool api_method_imp::nodeInfoReg(const user_info & uinfo, const std::string & account_name, const std::string & account_cert,
    ...
    top::base::xstream_t stream_t(top::base::xcontext_t::instance());
    std::string target_action_name = "node_info_reg";
    std::string param_t = stream_params(stream_t, account_name, account_cert);
