...
public:
    xtxindex_detail_t(const base::xvtxindex_ptr & txindex, std::string const & blockhash, const base::xvaction_t & txaction, uint64_t transaction_index);
    ~xtxindex_detail_t() {}
...
class xrpc_loader_t {
 ...
 public:  // json transfer
    ...
    static  Json::Value            load_and_parse_recv_tx(const std::string & raw_tx_hash, const xtxindex_detail_ptr_t & sendindex, data::enum_xunit_tx_exec_status & recvtx_status);
