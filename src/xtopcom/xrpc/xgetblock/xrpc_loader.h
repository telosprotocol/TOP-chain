...
class xrpc_loader_t {
 ...
 public:  // json transfer
    ...
    static  xJson::Value            load_and_parse_recv_tx(const std::string & raw_tx_hash, const xtxindex_detail_ptr_t & sendindex, bool & is_missing_index);
    static  xJson::Value            load_and_parse_confirm_tx(const std::string & raw_tx_hash, const xtxindex_detail_ptr_t & sendindex, const xJson::Value & recvjson, bool & is_missing_index);
    static  std::string             parse_tx_state(bool is_missing_index, const xJson::Value & sendjson, const xJson::Value & recvjson, const xJson::Value & confirmjson);
 private:
    static  xJson::Value            parse_recv_tx(const xtxindex_detail_ptr_t & sendindex, const xtxindex_detail_ptr_t & recvindex);
    static  xJson::Value            parse_confirm_tx(const xtxindex_detail_ptr_t & sendindex, const xtxindex_detail_ptr_t & confirmindex);
