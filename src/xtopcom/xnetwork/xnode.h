...
class xtop_dht_node : common::xnode_t<xnode_endpoint_t, common::xnode_id_t>
{
private:
    using base_t = common::xnode_t<xnode_endpoint_t, common::xnode_id_t>;
...
class xtop_node final : common::xnode_t<xnode_endpoint_t, common::xnode_id_t>
{
private:
    using base_t = common::xnode_t<xnode_endpoint_t, common::xnode_id_t>;
