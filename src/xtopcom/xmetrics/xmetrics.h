...
enum E_SIMPLE_METRICS_TAG : size_t {
    ...
    blockstore_get_genesis_block,
    blockstore_get_latest_cert_block,
    blockstore_get_latest_locked_block,
    blockstore_get_latest_committed_block,
    blockstore_get_latest_executed_block,
    blockstore_get_latest_connected_block,
    blockstore_get_latest_genesis_connected_block,
    blockstore_get_latest_genesis_connected_index,
    blockstore_get_latest_committed_full_block,
    blockstore_get_latest_committed_block_height,
    blockstore_get_latest_connected_block_height,
    blockstore_get_latest_genesis_connected_block_height,
    blockstore_get_latest_executed_block_height,
    blockstore_get_latest_blocks,
    blockstore_load_block_object,
    blockstore_load_block_input,
    blockstore_load_block_output,
    blockstore_delete_block,
    blockstore_query_tx,
    blockstore_query_block,
    blockstore_load_block_index,
    blockstore_load_block_flags,
    ...
    blockstore_access_from_statestore_load_unit_lastest_state,
    blockstore_access_from_statestore_get_block_state,
    blockstore_access_from_statestore_get_unit_block_state,
