...
namespace top {
    namespace chain_upgrade {
        ...
        xchain_fork_config_t  mainnet_chain_config{
            xfork_point_t{xfork_point_type_t::logic_time, 6513480, "block fork point for table receipt"},
            xfork_point_t{xfork_point_type_t::logic_time, 6522120, "table statistic info fork point"},
            xfork_point_t{xfork_point_type_t::logic_time, 6522480, "table receipt protocol fork point"},
        };
