...
namespace top {
    namespace chain_upgrade {
        ...
        xchain_fork_config_t  mainnet_chain_config{
            ...
            xfork_point_t{xfork_point_type_t::logic_time, 0, "block version 0.0.2.0 fork point"},
        };
        ...
        xchain_fork_config_t  mainnet_chain_config{
            ...
            xfork_point_t{xfork_point_type_t::logic_time, 6274516, "block version 0.0.2.0 fork point"},
        };
