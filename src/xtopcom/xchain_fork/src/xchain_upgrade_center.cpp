    ...
    namespace chain_fork {
        ...
        const uint32_t BLOCK_FORK_POINT = 0;
            ...
            xchain_fork_config_t  mainnet_chain_config{
                ...
                xfork_point_t{xfork_point_type_t::logic_time, 0, "onchain_parameter_name_fork_point"},
            };
        ...
        xchain_fork_config_t  mainnet_chain_config{
            ...
            xfork_point_t{xfork_point_type_t::logic_time, 20000000, "onchain_parameter_name_fork_point"},
        };
