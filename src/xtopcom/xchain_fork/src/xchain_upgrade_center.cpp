...
namespace top {
    namespace chain_fork {
        ...
        xchain_fork_config_t  mainnet_chain_config{
            xfork_point_t{xfork_point_type_t::logic_time, 6824520, "block fork point"},
            xfork_point_t{xfork_point_type_t::logic_time, 0, "table statistic info fork point"},
            xfork_point_t{xfork_point_type_t::logic_time, 6824520, "blacklist function fork point"},
            xfork_point_t{xfork_point_type_t::logic_time, 6824520, "node_initial_credit_fork_point"},
        };
