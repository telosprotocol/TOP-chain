...
namespace top {
    namespace chain_fork {
        ...
        public:
            ...
            static bool is_forked(top::optional<xfork_point_t> const & fork_point, uint64_t fork_point_offset, uint64_t target) noexcept;
        ...
        public:
            static void init();
            static void update(uint64_t cur_time, std::map<std::string, uint64_t> const & new_config);
