...
// #include "xpbase/base/xid/root_xid_manager.h"
...
// namespace test {
// 
// class TestRootXIdManager : public testing::Test {
// public:
...
// };
// 
// TEST_F(TestRootXIdManager, All) {
//     XIDManagerSptr xid_mgr;
//     xid_mgr.reset(new RootXIDManager());
//     xid_mgr->Init(250);
//     XIDType xid_type(kRoot,250);
