...
struct RLP {
    ...
    static Data encode(uint8_t number) noexcept { return encode(uint64_t(number)); }

    static Data encode(uint16_t number) noexcept { return encode(uint64_t(number)); }
    ...
    static Data encode(uint32_t number) noexcept { return encode(uint64_t(number)); }
    ...
    static Data encode(const uint64_t& number) noexcept ;
