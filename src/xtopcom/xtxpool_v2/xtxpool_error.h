...
enum enum_xtxpool_error_type {
    ...
    xtxpool_error_max,
    xtxpool_error_account_tx_not_audit_success,
};
...
inline std::string xtxpool_error_to_string(int32_t code) {
    ...
    static const char * names[] = {
        XTXPOOL_TO_STR(xtxpool_error_table_reached_upper_limit),
        ...
        XTXPOOL_TO_STR(xtxpool_error_account_tx_not_audit_success),
    };
