...
public:
    xtxmgr_table_t(xtxpool_table_info_t * xtable_info) : m_xtable_info(xtable_info), m_send_tx_queue(xtable_info), m_receipt_queue(xtable_info), m_pending_accounts(xtable_info) {
    }
