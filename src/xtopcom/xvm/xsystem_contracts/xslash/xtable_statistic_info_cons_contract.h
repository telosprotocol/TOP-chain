...
public:
     ...
     */
    void on_collect_statistic_info_cons(xstatistics_cons_data_t const& statistic_data, xfulltableblock_statistic_accounts const& statistic_accounts, uint64_t block_height);
    /**
     * @brief report the summarized statistic info
     * @param timestamp  the clock timer
     *
     */
    void report_summarized_statistic_info_cons(common::xlogic_time_t timestamp);
    ...
    CONTRACT_FUNCTION_PARAM(xtable_statistic_cons_contract, report_summarized_statistic_info_cons);
