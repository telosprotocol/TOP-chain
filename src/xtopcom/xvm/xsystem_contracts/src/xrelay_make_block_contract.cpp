...
bool xtop_relay_make_block_contract::build_tx_relay_block_detail(const evm_common::h256 & prev_hash, uint64_t block_height, uint64_t clock, uint64_t block_type) {
    ...
    xdbg("xtop_relay_make_block_contract::build_tx_relay_block height:%llu,pack_num:%d,cross tx:%d, block_type %d.", block_height, pack_num, cross_tx_list_size, block_type);
