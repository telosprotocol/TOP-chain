...
static void get_rec_nodes_map(common::xaccount_address_t const & contract_address,
    ...
    for (auto m : nodes) {
        ...
        j["node_deposit"] = reg_node_info.m_account_mortgage;
        ...
        j["vote_amount"] = reg_node_info.m_vote_amount;
        {
        ...
        j["auditor_stake"] = reg_node_info.get_auditor_stake();
        j["validator_stake"] = reg_node_info.get_validator_stake();
        j["rec_stake"] = reg_node_info.rec_stake();
        j["zec_stake"] = reg_node_info.zec_stake();
