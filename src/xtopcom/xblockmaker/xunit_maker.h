...
class xunit_maker_t : public xblock_maker_t {
 ...
 public:
    int32_t                 check_latest_state(const data::xblock_consensus_para_t & cs_para, const base::xaccount_index_t & commit_account_index, const base::xaccount_index_t & account_index, const xunit_block_cache & unit_block_cache);  // check block and state is latest
