...
public:
    static const std::string build(uint64_t clock, data::enum_eth_header_format format, uint64_t gas_limit, const std::vector<txexecutor::xatomictx_output_t> & pack_txs_outputs = {});
