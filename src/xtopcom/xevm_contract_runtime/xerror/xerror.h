...
/// should same as `engine/src/error.rs` `EngineErrorKind`
...
template <>
struct is_error_code_enum<top::contract_runtime::evm::error::xerrc_t> : std::true_type {};

template <>
struct is_error_condition_enum<top::contract_runtime::evm::error::xerrc_t> : std::true_type {};
