...
namespace top
{
    namespace utl
    {
        ...
        public: //following can only be used at TOP
            ...
            std::string       to_eth_address(const char addr_type,const uint16_t ledger_id);
            ...
            std::string       to_eth_address(const std::string & parent_addr,const char addr_type,const uint16_t ledger_id);            
        protected:
