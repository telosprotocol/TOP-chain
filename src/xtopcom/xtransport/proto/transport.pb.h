...
class GossipParams : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:top.transport.protobuf.GossipParams) */ {
 public:
  ...
  static const int kHeaderHashFieldNumber = 11;
  ...
  static const int kSwitchLayerHopNumFieldNumber = 10;
  ...
  static const int kIgnBloomfilterLevelFieldNumber = 13;
  ...
  void clear_diff_net();
  static const int kDiffNetFieldNumber = 14;
  bool diff_net() const;
  ...
  void clear_msg_hash();
  static const int kMsgHashFieldNumber = 15;
...
class RoutingMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:top.transport.protobuf.RoutingMessage) */ {
 public:
  ...
  bool has_xid() const;
  void clear_xid();
  static const int kXidFieldNumber = 13;
  ...
  void clear_debug();
  static const int kDebugFieldNumber = 17;
  ...
  void clear_gossip();
  static const int kGossipFieldNumber = 16;
  private:
  ...
  static const int kBroadcastFieldNumber = 14;
