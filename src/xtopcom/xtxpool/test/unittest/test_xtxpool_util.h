...
public:
    ...
    static xblock_t *                           create_unit_with_cons_txs(xstore_face_t * store, const std::string & address, const std::vector<xcons_transaction_ptr_t> & txs);
    ...
    static xblock_t *                           create_tableblock_with_cons_txs_with_next_two_emptyblock(xstore_face_t *                              store,
                                                                const std::string &                          address,
                                                                base::xvblock_t *                            unit_genesis_block,
                                                                const std::vector<xcons_transaction_ptr_t> & txs,
                                                                uint64_t                                     tx_clock,
