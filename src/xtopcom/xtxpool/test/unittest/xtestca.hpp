...
namespace top
{
    namespace test
    {
        ...
        public:
            ...
            void set_verify_muti_sign_ret(base::enum_vcert_auth_result ret) {muti_sign_ret = ret;};
            
        private:
            uint32_t        m_total_nodes;
            base::enum_vcert_auth_result muti_sign_ret = base::enum_vcert_auth_result::enum_successful;
        };
    };
};
