...
private:
    ...
    statectx::xstatectx_face_ptr_t m_state_ctx;
...
public:
    ...
    xtop_contract_state(common::xaccount_address_t action_account_addr, statectx::xstatectx_face_ptr_t const state_ctx);
