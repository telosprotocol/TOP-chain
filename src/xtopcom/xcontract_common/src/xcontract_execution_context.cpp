...
xtop_contract_execution_context::xtop_contract_execution_context(data::xtop_action_t action, observer_ptr<xcontract_state_t> s) noexcept : m_contract_state{ s }, m_action{ std::move(action) } {
}
