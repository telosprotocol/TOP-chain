...
#else
XDECLARE_ONCHAIN_GOVERNANCE_PARAMETER(punish_interval_time_block, xinterval_t, normal, 366, 0, std::numeric_limits<xinterval_t>::max()); // 61minute(just for a prime time)
