...
extern "C" bool unsafe_verify_merkle_proof(uint8_t const * leaf_ptr,
                                           uint8_t const * branch_ptr,
                                           uint64_t branch_data_size,
                                           uint64_t depth,
                                           uint64_t index,
                                           uint8_t const * root_ptr);
...
extern "C" bool unsafe_compute_bellatrix_committee_signing_root(uint8_t const * object_root_ptr, uint64_t version, uint8_t * signing_root_ptr);
