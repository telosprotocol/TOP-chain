...
class xaction_asset_proc : public xaction_face_t {
 public:
    ...
    int32_t parse(const xaction_t & action) override;
    static int32_t serialze_to(xaction_t & action, const data::xproperty_asset & asset, uint16_t action_type);
    bool is_top_token() const;
 public:
...
public:
    enum_xaction_type action_type() { return xaction_type_asset_in; };
};

class xaction_pledge_token : public xaction_asset_proc {
public:
    enum_xaction_type action_type() { return xaction_type_pledge_token; };
};

class xaction_redeem_token : public xaction_asset_proc {
public:
    enum_xaction_type action_type() { return xaction_type_redeem_token; };
};
