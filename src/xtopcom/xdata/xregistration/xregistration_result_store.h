...
class xtop_registration_result_store {
private:
    using container_t = std::map<common::xnetwork_id_t, xregistration_chain_result_t>;
...
public:
    ...
    std::map<common::xnetwork_id_t, xregistration_chain_result_t> const &
    results() const noexcept;

    void
    results(std::map<common::xnetwork_id_t, xregistration_chain_result_t> && r) noexcept;
...
using xregistration_result_store_t = xtop_registration_result_store;
