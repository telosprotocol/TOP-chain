...
namespace data {
    ...
    private:
      ...
      //uint64_t            m_epochID{0};              // Epoch id of this block's epoch. Used for retrieving validator information
        ...
        static const unsigned inner_fileds = 5;        
    };
    ...
    public:
        ...
        static const size_t block_header_fileds = 6;

        xbytes_t                        encodeBytes(bool withSignature = false) const;
        void                            decodeBytes(xbytes_t const& _d, std::error_code & ec,  bool withSignature = false);
    ...
    public:
       ...
       void                             set_signature_groups(const xrelay_signature_group_t &signature_nodes);
       ...
       const evm_common::h256           &get_block_merkle_root_hash() const { return m_inner_header.get_block_merkle_root_hash();}
       ...
       const evm_common::u256           &get_chain_bits() const{ return m_chain_bits;}
    ...
    protected:
       ...
       void                             decodeRLP(evm_common::RLP const& _r,  std::error_code & ec, bool withSignature) ;
    ...
    private:
        ...
        evm_common::u256                        m_chain_bits{0};              //chain id for transaction block.
    ...
    public:
        ...
        const evm_common::u256              &get_chain_bits()  const{ return m_header.get_chain_bits();}
