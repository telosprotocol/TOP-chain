...
class xtransaction_v2_t : public xbase_dataunit_t<xtransaction_v2_t, xdata_type_transaction_v2>, public xtransaction_t {
 public:
    // static std::string transaction_type_to_string(uint16_t type); public:
    xtransaction_v2_t();
 protected:
 ...
 public:
    ...
    // virtual int32_t    get_obj_type() override {return xbase_dataunit_t<xtransaction_v2_t, xdata_type_transaction_v2>::get_obj_type();}
 ...
 public:  // set apis
    ...
    void                set_source_addr(const std::string & addr) { m_source_account = addr; }
    void                set_target_addr(const std::string & addr) { m_target_account = addr; }
 ...
 public:  // get apis
    ...
    virtual const std::string & get_source_addr()const override {return m_source_account;}
    virtual const std::string & get_target_addr()const override {return m_adjust_target_addr.empty() ? m_target_account : m_adjust_target_addr;}
    virtual const std::string & get_origin_target_addr()const override {return m_target_account;}
    ...
    virtual xaction_t &         get_source_action() override { m_source_action.set_action_name(m_source_action_name); m_source_action.set_action_param(m_source_action_para); return m_source_action;}
    virtual xaction_t &         get_target_action() override { m_target_action.set_action_name(m_target_action_name); m_target_action.set_action_param(m_target_action_para); return m_target_action;}
 ...
 public:
    ...
    virtual void set_tx_len(uint16_t len) override {m_transaction_len = len; xdbg("wish tx_len:%d, tx_hash:%s", m_transaction_len, get_digest_hex_str().c_str()); };
    virtual uint16_t get_tx_len() const override {xdbg("wish tx_len:%d, tx_hash:%s", m_transaction_len, get_digest_hex_str().c_str()); return m_transaction_len;};
