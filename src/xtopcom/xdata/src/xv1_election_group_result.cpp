...
v0::xelection_group_result_t xtop_election_group_result::v0() const {
    v0::xelection_group_result_t r;
    ...
    std::transform(std::begin(m_nodes), std::end(m_nodes), std::inserter(r, std::end(r)), [](value_type const & input) -> v0::xelection_group_result_t::value_type {
