...
bool xtop_election_info::operator==(xtop_election_info const & other) const noexcept {
    return joined_version == other.joined_version && stake == other.stake && comprehensive_stake == other.comprehensive_stake && consensus_public_key == other.consensus_public_key;
}
