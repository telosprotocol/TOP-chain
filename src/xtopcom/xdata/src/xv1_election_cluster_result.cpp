...
v0::xelection_cluster_result_t xtop_election_cluster_result::v0() const {
    v0::xelection_cluster_result_t r;

    std::transform(
        std::begin(m_group_results), std::end(m_group_results), std::inserter(r, std::end(r)), [](value_type const & input) -> v0::xelection_cluster_result_t::value_type {
