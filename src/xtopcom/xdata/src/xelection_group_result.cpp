...
xtop_election_group_result::associated_group_id() const noexcept {
    return m_associated_group_id;
}

void
xtop_election_group_result::associated_group_id(common::xgroup_id_t gid) noexcept {
...
xtop_election_group_result::timestamp() const noexcept {
    return m_timestamp;
}

void
xtop_election_group_result::timestamp(common::xlogic_time_t const time) noexcept {
    m_timestamp = time;
}

common::xlogic_time_t
xtop_election_group_result::start_time() const noexcept {
    assert(m_start_time != common::xjudgement_day);
    return m_start_time;
}

void
xtop_election_group_result::start_time(common::xlogic_time_t const time) noexcept {
    assert(time != common::xjudgement_day && (time >= m_start_time || m_start_time == common::xjudgement_day));
    m_start_time = time;
}
...
std::pair<xtop_election_group_result::iterator, bool>
xtop_election_group_result::insert(xelection_info_bundle_t const & value) {
...
std::pair<xtop_election_group_result::iterator, bool>
xtop_election_group_result::insert(xelection_info_bundle_t && value) {
    auto find_result = find(value.node_id());
    if (top::get<bool>(find_result)) {
        return { m_nodes.find(top::get<common::xslot_id_t>(find_result)), false };
    }
...
bool
xtop_election_group_result::empty() const noexcept {
...
xtop_election_group_result::results() const noexcept {
    return m_nodes;
}

void
xtop_election_group_result::results(std::map<common::xslot_id_t, xelection_info_bundle_t> && r) noexcept {
    m_nodes = std::move(r);
}

xelection_info_t const &
xtop_election_group_result::result_of(common::xnode_id_t const & node_id) const {
...
xelection_info_t &
xtop_election_group_result::result_of(common::xnode_id_t const & node_id) {
...
std::size_t
xtop_election_group_result::size() const noexcept {
    std::size_t size{ 0 };
    for (auto const & node_info : m_nodes) {
...
xtop_election_group_result::iterator
xtop_election_group_result::begin() noexcept {
    return m_nodes.begin();
}

xtop_election_group_result::const_iterator
xtop_election_group_result::begin() const noexcept {
    return m_nodes.begin();
}

xtop_election_group_result::const_iterator
xtop_election_group_result::cbegin() const noexcept {
    return m_nodes.cbegin();
}

xtop_election_group_result::iterator
xtop_election_group_result::end() noexcept {
    return m_nodes.end();
}

xtop_election_group_result::const_iterator
xtop_election_group_result::end() const noexcept {
    return m_nodes.end();
}

xtop_election_group_result::const_iterator
xtop_election_group_result::cend() const noexcept {
    return m_nodes.cend();
}

void
xtop_election_group_result::reset(common::xnode_id_t const & node_id) {
    auto find_result = find(node_id);
    if (top::get<bool>(find_result)) {
...
void
xtop_election_group_result::reset(iterator pos) {
...
xtop_election_group_result::find(common::xnode_id_t const & nid) const noexcept {
