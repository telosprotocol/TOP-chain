...
// void xtransaction_v1_t::set_digest_2() {
//     base::xstream_t out(base::xcontext_t::instance());
...
//     std::string compact_source_account = base::xvaccount_t::compact_address_to(m_source_action.get_account_addr());
//     out << compact_source_account;
//     std::string compact_target_account = base::xvaccount_t::compact_address_to(m_target_action.get_account_addr());
//     out << compact_target_account;
//     out.write_compact_var(m_edge_nodeid);

//     data::xaction_asset_out sa;
//     int32_t ret = sa.parse(m_source_action);
//     out.write_compact_var(sa.m_asset_out.m_amount);
//     out.write_compact_var(sa.m_asset_out.m_token_name);
...
//     if(m_transaction_type != xtransaction_type_transfer) {
//         out.write_compact_var(m_source_action.get_action_name());
//         out.write_compact_var(m_source_action.get_action_param());
//         out.write_compact_var(m_target_action.get_action_name());
//         out.write_compact_var(m_target_action.get_action_param());
//     }

//     m_transaction_hash = utl::xsha2_256_t::digest((const char*)out.data(), out.size());
// }
