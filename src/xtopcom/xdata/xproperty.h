...
XINLINE_CONSTEXPR char const* XPORPERTY_ZEC_REG_KEY = "@201";
XINLINE_CONSTEXPR char const* XPORPERTY_ZEC_CROSS_READING_REC_REG_BLOCK_HEIGHT = "@201-CRH";
XINLINE_CONSTEXPR char const* XPORPERTY_ZEC_CROSS_READING_REC_REG_LOGIC_TIME = "@201-CRT";
XINLINE_CONSTEXPR char const* XPORPERTY_ZEC_CROSS_READING_REC_STEP = "@201-CRS";
XINLINE_CONSTEXPR char const* XPORPERTY_ZEC_CROSS_READING_REC_TIMEOUT_LIMIT = "@201-CRL";

XINLINE_CONSTEXPR char const* XPROPERTY_LAST_READ_REC_REG_CONTRACT_BLOCK_HEIGHT = "@201-LRH";
XINLINE_CONSTEXPR char const* XPROPERTY_LAST_READ_REC_REG_CONTRACT_LOGIC_TIME = "@201-LRT";
