...
XINLINE_CONSTEXPR char const * XPROPERTY_PRECOMPILED_ERC20_OWNER_KEY = "$12";
XINLINE_CONSTEXPR char const * XPROPERTY_PRECOMPILED_ERC20_CONTROLLER_KEY = "$13";
...
XINLINE_CONSTEXPR char const* XPROPERTY_CONTRACT_TABLE_FORK_INFO_KEY = "@00";
XINLINE_CONSTEXPR char const* XPROPERTY_CONTRACT_TABLE_FORK_INDEX_KEY = "@00-i";
