...
// relay block related
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_LAST_POLY_BLOCK_LOGIC_TIME = "@161";
// XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_LAST_BLOCK_TYPE = "@162";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_CROSS_TXS = "@163";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_BLOCK_HASH_LAST_ELECT_TO_LAST_POLY_LIST = "@164";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_BLOCK_HASH_FROM_LAST_POLY_LIST = "@165";
