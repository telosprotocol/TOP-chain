...
XINLINE_CONSTEXPR const char * XPROPERTY_FINALIZED_BEACON_HEADER = "@182";
XINLINE_CONSTEXPR const char * XPROPERTY_FINALIZED_EXECUTION_HEADER = "@183";
XINLINE_CONSTEXPR const char * XPROPERTY_CURRENT_SYNC_COMMITTEE = "@184";
XINLINE_CONSTEXPR const char * XPROPERTY_NEXT_SYNC_COMMITTEE = "@185";
