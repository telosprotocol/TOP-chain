...
XINLINE_CONSTEXPR const char * XPROPERTY_ETH_CHAINS_HASH = "@160";
XINLINE_CONSTEXPR const char * XPROPERTY_ETH_CHAINS_HEADER = "@161";
XINLINE_CONSTEXPR const char * XPROPERTY_ETH_CHAINS_HEIGHT = "@162";

// relay block related
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_LAST_POLY_BLOCK_LOGIC_TIME = "@160";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_LAST_HEIGHT = "@161";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_LAST_HASH = "@162";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_LAST_EPOCH_ID = "@163";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_CROSS_TXS = "@164";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_BLOCK_HASH_LAST_ELECT_TO_LAST_POLY_LIST = "@165";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_BLOCK_HASH_FROM_LAST_POLY_LIST = "@166";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_BLOCK_STR = "@167";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_WRAP_PHASE = "@168";
XINLINE_CONSTEXPR const char * XPROPERTY_RELAY_ELECT_PACK_HEIGHT = "@169";
