...
XINLINE_CONSTEXPR const char * XPROPERTY_ETH_CHAINS_HASH = "@150";
XINLINE_CONSTEXPR const char * XPROPERTY_ETH_CHAINS_HEADER = "@151";
XINLINE_CONSTEXPR const char * XPROPERTY_ETH_CHAINS_HEIGHT = "@152";
