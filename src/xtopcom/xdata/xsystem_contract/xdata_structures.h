...
XINLINE_CONSTEXPR char const * XPROPERTY_PRE_LAST_VALIDATOR_SET = "@166";
XINLINE_CONSTEXPR char const * XPROPERTY_LAST_VALIDATOR_SET = "@167";
XINLINE_CONSTEXPR char const * XPROPERTY_RECENT_SNAPSHOTS = "@168";
