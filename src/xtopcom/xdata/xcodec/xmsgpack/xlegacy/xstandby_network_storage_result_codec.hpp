...
template <>
struct convert<top::data::election::legacy::xstandby_network_storage_result_t> final
{
    msgpack::object const &
    operator()(msgpack::object const & o, top::data::election::legacy::xstandby_network_storage_result_t & result) const {
        ...
        switch (o.via.array.size - 1) {
            ...
            case xlegacy_standby_network_storage_result_result_index: {
                result.results(
                    o.via.array.ptr[xlegacy_standby_network_storage_result_result_index].as<std::map<top::common::xnode_id_t, top::data::election::legacy::xstandby_node_info_t>>());
                XATTRIBUTE_FALLTHROUGH;
            }
        }
...
template <>
struct pack<::top::data::election::legacy::xstandby_network_storage_result_t>
{
    template <typename StreamT>
    msgpack::packer<StreamT> &
    operator()(msgpack::packer<StreamT> & o, top::data::election::legacy::xstandby_network_storage_result_t const & result) const {
...
template <>
struct object_with_zone<top::data::election::legacy::xstandby_network_storage_result_t>
{
    void
    operator()(msgpack::object::with_zone & o, top::data::election::legacy::xstandby_network_storage_result_t const & result) const {
