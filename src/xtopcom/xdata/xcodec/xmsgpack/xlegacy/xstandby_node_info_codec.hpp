...
struct convert<top::data::election::legacy::xstandby_node_info_t> final {
    msgpack::object const & operator()(msgpack::object const & o, top::data::election::legacy::xstandby_node_info_t & node_info) const {
...
template <>
struct pack<::top::data::election::legacy::xstandby_node_info_t> {
    template <typename StreamT>
    msgpack::packer<StreamT> & operator()(msgpack::packer<StreamT> & o, top::data::election::legacy::xstandby_node_info_t const & node_info) const {
...
template <>
struct object_with_zone<::top::data::election::legacy::xstandby_node_info_t> {
    void operator()(msgpack::object::with_zone & o, top::data::election::legacy::xstandby_node_info_t const & node_info) const {
