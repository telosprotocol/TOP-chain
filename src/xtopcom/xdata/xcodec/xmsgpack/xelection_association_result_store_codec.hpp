...
template <>
struct convert<top::data::election::xelection_association_result_store_t> final
{
    msgpack::object const &
    operator()(msgpack::object const & o,
               top::data::election::xelection_association_result_store_t & result) const {
        ...
        switch (o.via.array.size - 1) {
            ...
            case xelection_association_result_store_results_index: {
                result.results(o.via.array.ptr[xelection_association_result_store_results_index].as<std::map<top::common::xcluster_id_t, top::data::election::xelection_association_result_t>>());
                XATTRIBUTE_FALLTHROUGH;
            }
        }
        return o;
...
template <>
struct pack<::top::data::election::xelection_association_result_store_t>
{
    template <typename StreamT>
    msgpack::packer<StreamT> &
    operator()(msgpack::packer<StreamT> & o,
               top::data::election::xelection_association_result_store_t const & result) const {
...
template <>
struct object_with_zone<top::data::election::xelection_association_result_store_t>
{
    void
