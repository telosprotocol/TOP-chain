...
template <>
struct convert<top::data::registration::xzec_registration_node_info_t> final {
    msgpack::object const & operator()(msgpack::object const & o, top::data::registration::xzec_registration_node_info_t & result) const {
        ...
        case xzec_registration_node_info_nick_name: {
            result.m_nickname = o.via.array.ptr[xzec_registration_node_info_nick_name].as<std::string>();
            XATTRIBUTE_FALLTHROUGH;
        }
        case xzec_registration_node_info_role_type: {
            result.m_role_type = o.via.array.ptr[xzec_registration_node_info_role_type].as<top::common::xrole_type_t>();
            XATTRIBUTE_FALLTHROUGH;
        }
        case xzec_registration_node_info_rec_registration_info: {
            result.m_rec_registration_node_info = o.via.array.ptr[xzec_registration_node_info_rec_registration_info].as<top::data::registration::xrec_registration_node_info_t>();
            XATTRIBUTE_FALLTHROUGH;
        }
        }
