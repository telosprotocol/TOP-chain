...
struct convert<top::data::election::v2::xelection_info_t> final {
    msgpack::object const & operator()(msgpack::object const & o, top::data::election::v2::xelection_info_t & election_info) const {
        ...
        case xelection_info_consensus_public_key_index: {
            election_info.public_key(o.via.array.ptr[xelection_info_consensus_public_key_index].as<top::xpublic_key_t>());
            XATTRIBUTE_FALLTHROUGH;
        }
...
template <>
struct pack<::top::data::election::v2::xelection_info_t> {
    template <typename StreamT>
    msgpack::packer<StreamT> & operator()(msgpack::packer<StreamT> & o, top::data::election::v2::xelection_info_t const & election_info) const {
...
template <>
struct object_with_zone<::top::data::election::v2::xelection_info_t> {
    void operator()(msgpack::object::with_zone & o, top::data::election::v2::xelection_info_t const & election_info) const {
        o.type = msgpack::type::ARRAY;
        o.via.array.size = xelection_info_field_count;
        o.via.array.ptr = static_cast<msgpack::object *>(o.zone.allocate_align(sizeof(::msgpack::object) * o.via.array.size));
        o.via.array.ptr[xelection_info_joined_version_index] = msgpack::object{election_info.joined_epoch(), o.zone};
        ...
        o.via.array.ptr[xelection_info_consensus_public_key_index] = msgpack::object{election_info.public_key(), o.zone};
