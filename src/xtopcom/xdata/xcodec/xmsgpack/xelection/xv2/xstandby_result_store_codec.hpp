...
#include "xdata/xcodec/xmsgpack/xelection/xv2/xstandby_network_storage_result_codec.hpp"
...
template <>
struct convert<top::data::election::v2::xstandby_result_store_t> final {
    msgpack::object const & operator()(msgpack::object const & o, top::data::election::v2::xstandby_result_store_t & result) const {
...
template <>
struct pack<::top::data::election::v2::xstandby_result_store_t> {
    template <typename StreamT>
    msgpack::packer<StreamT> & operator()(msgpack::packer<StreamT> & o, top::data::election::v2::xstandby_result_store_t const & result) const {
...
template <>
struct object_with_zone<top::data::election::v2::xstandby_result_store_t> {
    void operator()(msgpack::object::with_zone & o, top::data::election::v2::xstandby_result_store_t const & result) const {
