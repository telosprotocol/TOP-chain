...
#include "xdata/xcodec/xmsgpack/xelection/xv2/xelection_info_bundle_codec.hpp"
#include "xdata/xcodec/xmsgpack/xelection/xv2/xelection_info_codec.hpp"
#include "xdata/xelection/xv2/xelection_group_result.h"
...
template <>
struct convert<top::data::election::v2::xelection_group_result_t> final {
    msgpack::object const & operator()(msgpack::object const & o, top::data::election::v2::xelection_group_result_t & result) const {
...
template <>
struct pack<::top::data::election::v2::xelection_group_result_t> {
    template <typename StreamT>
    msgpack::packer<StreamT> & operator()(msgpack::packer<StreamT> & o, top::data::election::v2::xelection_group_result_t const & result) const {
...
template <>
struct object_with_zone<top::data::election::v2::xelection_group_result_t> {
    void operator()(msgpack::object::with_zone & o, top::data::election::v2::xelection_group_result_t const & result) const {
