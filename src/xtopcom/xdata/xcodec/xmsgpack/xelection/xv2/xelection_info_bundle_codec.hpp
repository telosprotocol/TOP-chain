...
template <>
struct convert<top::data::election::v2::xelection_info_bundle_t> final {
    msgpack::object const & operator()(msgpack::object const & o, top::data::election::v2::xelection_info_bundle_t & info_bundle) const {
        ...
        switch (o.via.array.size - 1) {
            ...
            case xelection_info_bundle_election_info_index: {
                info_bundle.election_info(o.via.array.ptr[xelection_info_bundle_election_info_index].as<top::data::election::v2::xelection_info_t>());
                XATTRIBUTE_FALLTHROUGH;
            }
...
template <>
struct pack<::top::data::election::v2::xelection_info_bundle_t> {
...
template <>
struct object_with_zone<::top::data::election::v2::xelection_info_bundle_t> {
    void operator()(msgpack::object::with_zone & o, top::data::election::v2::xelection_info_bundle_t const & info_bundle) const {
