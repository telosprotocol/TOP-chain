...
template <>
struct convert<top::data::election::v1::xelection_group_result_t> final {
    msgpack::object const & operator()(msgpack::object const & o, top::data::election::v1::xelection_group_result_t & result) const {
        ...
        switch (o.via.array.size - 1) {
            ...
            case xv1_election_group_result_start_time_index: {
                result.start_time(array[xv1_election_group_result_start_time_index].as<top::common::xlogic_time_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xv1_election_group_result_timestamp_index: {
                result.timestamp(array[xv1_election_group_result_timestamp_index].as<top::common::xlogic_time_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xv1_election_group_result_election_committee_version_index: {
                result.election_committee_version(array[xv1_election_group_result_election_committee_version_index].as<top::common::xelection_round_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xv1_election_group_result_cluster_version_index: {
                result.cluster_version(array[xv1_election_group_result_cluster_version_index].as<top::common::xelection_round_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xv1_election_group_result_associated_group_version_index: {
                result.associated_group_version(array[xv1_election_group_result_associated_group_version_index].as<top::common::xelection_round_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xv1_election_group_result_group_version_index: {
                result.group_version(array[xv1_election_group_result_group_version_index].as<top::common::xelection_round_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xv1_election_group_result_associated_group_id_index: {
                result.associated_group_id(array[xv1_election_group_result_associated_group_id_index].as<top::common::xgroup_id_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xv1_election_group_result_results_index: {
                result.results(array[xv1_election_group_result_results_index].as<std::map<top::common::xslot_id_t, top::data::election::v1::xelection_info_bundle_t>>());
                XATTRIBUTE_FALLTHROUGH;
            }
        }
...
template <>
struct pack<::top::data::election::v1::xelection_group_result_t> {
    template <typename StreamT>
    msgpack::packer<StreamT> & operator()(msgpack::packer<StreamT> & o, top::data::election::v1::xelection_group_result_t const & result) const {
...
template <>
struct object_with_zone<top::data::election::v1::xelection_group_result_t> {
    void operator()(msgpack::object::with_zone & o, top::data::election::v1::xelection_group_result_t const & result) const {
