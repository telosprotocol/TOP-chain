...
template <>
struct convert<top::data::election::v1::xstandby_node_info_t> final {
    msgpack::object const & operator()(msgpack::object const & o, top::data::election::v1::xstandby_node_info_t & node_info) const {
        ...
        case xv1_standby_node_info_miner_type_index: {
            node_info.miner_type = o.via.array.ptr[xv1_standby_node_info_miner_type_index].as<top::common::xminer_type_t>();
            XATTRIBUTE_FALLTHROUGH;
        }
        ...
        case xv1_standby_node_info_stake_index: {
            node_info.stake_container = o.via.array.ptr[xv1_standby_node_info_stake_index].as<std::map<top::common::xnode_type_t, uint64_t>>();
            XATTRIBUTE_FALLTHROUGH;
        }
        

        case xv1_standby_node_info_public_key_index: {
            node_info.consensus_public_key = o.via.array.ptr[xv1_standby_node_info_public_key_index].as<top::xpublic_key_t>();
            XATTRIBUTE_FALLTHROUGH;
        }
        }
...
template <>
struct pack<::top::data::election::v1::xstandby_node_info_t> {
    template <typename StreamT>
    msgpack::packer<StreamT> & operator()(msgpack::packer<StreamT> & o, top::data::election::v1::xstandby_node_info_t const & node_info) const {
...
template <>
struct object_with_zone<::top::data::election::v1::xstandby_node_info_t> {
    void operator()(msgpack::object::with_zone & o, top::data::election::v1::xstandby_node_info_t const & node_info) const {
