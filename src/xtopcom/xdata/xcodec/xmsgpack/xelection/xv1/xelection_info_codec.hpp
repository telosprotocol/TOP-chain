...
template <>
struct convert<top::data::election::v1::xelection_info_t> final {
    msgpack::object const & operator()(msgpack::object const & o, top::data::election::v1::xelection_info_t & election_info) const {
...
template <>
struct pack<::top::data::election::v1::xelection_info_t> {
...
template <>
struct object_with_zone<::top::data::election::v1::xelection_info_t> {
    void operator()(msgpack::object::with_zone & o, top::data::election::v1::xelection_info_t const & election_info) const {
