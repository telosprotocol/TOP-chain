...
class xcons_transaction_t : public xbase_dataunit_t<xcons_transaction_t, xdata_type_cons_transaction> {
 ...
 public:
    ...
    void                    set_receipt_data(base::receipt_data_t data) {m_receipt->set_receipt_data(data);}
    base::receipt_data_t    get_receipt_data() const {return m_receipt->get_receipt_data();}
