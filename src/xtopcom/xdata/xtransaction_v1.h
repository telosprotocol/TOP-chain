...
class xtransaction_v1_t : public xbase_dataunit_t<xtransaction_v1_t, xdata_type_transaction>, public xtransaction_t {
 ...
 public:
    ...
    virtual int32_t    serialize_to(base::xstream_t & stream) override {xdbg("xtransaction_v1_t");return xbase_dataunit_t<xtransaction_v1_t, xdata_type_transaction>::serialize_to(stream);}
    virtual int32_t    serialize_from(base::xstream_t & stream) override {xdbg("xtransaction_v1_t");return xbase_dataunit_t<xtransaction_v1_t, xdata_type_transaction>::serialize_from(stream);}      //serialize header and object,return how many bytes is readed
    ...
    // virtual int32_t    get_obj_type() override {return xbase_dataunit_t<xtransaction_v1_t, xdata_type_transaction>::get_obj_type();}
 ...
 public:  // check apis
    // virtual bool        transaction_type_check() const override;
 ...
 public:  // set apis
    ...
    virtual void        set_source_action(const xaction_t & action) override {m_source_action = action;};
    virtual void        set_target_action(const xaction_t & action) override {m_target_action = action;};
 ...
 public:  // get apis
    ...
    virtual xaction_t &         get_source_action() override {return m_source_action;}
