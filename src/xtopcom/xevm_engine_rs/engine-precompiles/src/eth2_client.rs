...
pub struct Eth2ClientPrecompile;

impl Eth2ClientPrecompile {
    pub(super) const ADDRESS: Address = crate::make_address(0xff000000, 9);
}

impl Precompile for Eth2ClientPrecompile {
