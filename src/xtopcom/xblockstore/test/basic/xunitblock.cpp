...
namespace top
{
    namespace test
    {
        ...
        xclockblock_t::xclockblock_t(xunitheader_t & header,xunitcert_t & cert)
        ...
        xunitblock_t::xunitblock_t(xunitheader_t & header,xunitcert_t & cert)
          : base::xvblock_t(header,cert)
        {
        }
        ...
        base::xauto_ptr<base::xvblock_t>  xunitblockstore_t::get_latest_full_block(const std::string & account)
        {
            ...
            return load_block_object(account,_latest_block->get_last_full_block_height());
        }
        ...
        base::xauto_ptr<base::xvblock_t>     xunitblockstore_t::load_block_object(const std::string & account,const uint64_t height,bool ask_full_load)
        {
            ...
            base::xvblock_t* new_block_ptr = create_block_object(_header_cert_bin);
        ...
        base::xauto_ptr<base::xvblock_t>    xunitblockstore_t::load_block_object(const base::xvaccount_t & account,const uint64_t height,bool ask_full_load)
        {
            return load_block_object(account.get_address(),height,ask_full_load);
        }
        ...
        int32_t   xunitblockstore_t::do_write(base::xstream_t & stream)  //serialize whole object to binary
        {
            return 0;
        }
        int32_t   xunitblockstore_t::do_read(base::xstream_t & stream)   //serialize from binary and regeneate content of xdataobj_t
        {
            return 0;
        }
    }
