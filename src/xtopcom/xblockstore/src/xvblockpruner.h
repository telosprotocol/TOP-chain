...
namespace top
{
    ...
    public:
        ...
        virtual bool refresh(const chainbase::enum_xmodule_type mod_id, const base::xvaccount_t & account_obj, const uint64_t permit_prune_upper_boundary) override;  // just for
                                                                                                                                                                      // table

    protected:
        base::xvdbstore_t * get_xvdb() const {
            return m_xvdb_ptr;
        }
    ...
    private:
        ...
        std::map<std::string, prune_type> m_prune_table;
    };
    }
}
