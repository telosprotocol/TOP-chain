...
namespace top
{
    namespace store
    {
        ...
        base::xvblock_t * xvblockstore_impl::load_block_from_index(xblockacct_t* target_account, base::xvbindex_t* target_index,const uint64_t target_height,bool ask_full_load, const int atag)
        {
        ...
        base::xvblock_t * xvblockstore_impl::load_block_from_self_index(xblockacct_t* target_account, base::xvbindex_t* target_index,bool ask_full_load, const int atag)
        {
            if(!target_index)
            {
