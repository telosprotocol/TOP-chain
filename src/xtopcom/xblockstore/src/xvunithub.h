...
namespace top
{
    namespace store
    {
        ...
        public://better performance,and return raw ptr with added reference,caller respond to release it after that.
            ...
            virtual bool     set_latest_executed_info(const base::xvaccount_t & account,uint64_t height) override;
        ...
        public: // unit related apis
            ...
            virtual bool    delete_unit(const base::xvaccount_t & account,base::xvblock_t* block) override;
