...
namespace top
{
    namespace store
    {
        ...
        public://better performance,and return raw ptr with added reference,caller respond to release it after that.
            ...
            virtual uint64_t get_latest_committed_block_height(const base::xvaccount_t & account) override;
        ...
        protected:
            ...
            base::xvblock_t *            load_block_from_index(xblockacct_t* target_account, base::xvbindex_t* target_index,const uint64_t target_height,bool ask_full_load);
            ...
            base::xvblock_t *            load_block_from_self_index(xblockacct_t* target_account, base::xvbindex_t* target_index,bool ask_full_load);
