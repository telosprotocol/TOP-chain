...
class xstate_tablestate_reseter_continuous_sample : public xstate_tablestate_reseter_base {
public:
    xstate_tablestate_reseter_continuous_sample(statectx::xstatectx_face_ptr_t statectx_ptr, std::string const & fork_name);
