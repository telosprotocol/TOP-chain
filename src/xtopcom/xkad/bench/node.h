...
public:
    ...
    // ---------------- getrt2/rtsize/getrt3/getrt4
    void ClearRtdiff();
    void OnCommandGetrt2(const BenchCommand::Arguments& args);  // get all from other
    void OnCommandRtsize(const BenchCommand::Arguments& args);  // rtsize -> node list
    void OnCommandGetrt3(const BenchCommand::Arguments& args);  // 
    void OnCommandGetrt4(const BenchCommand::Arguments& args);  // HexSubstr -> node list
