...
class RootGetElectNodesRequest;
class RootGetElectNodesRequestDefaultTypeInternal;
extern RootGetElectNodesRequestDefaultTypeInternal _RootGetElectNodesRequest_default_instance_;
class RootGetElectNodesResponse;
class RootGetElectNodesResponseDefaultTypeInternal;
extern RootGetElectNodesResponseDefaultTypeInternal _RootGetElectNodesResponse_default_instance_;
...
template<> ::top::kadmlia::protobuf::RootGetElectNodesRequest* Arena::CreateMaybeMessage<::top::kadmlia::protobuf::RootGetElectNodesRequest>(Arena*);
template<> ::top::kadmlia::protobuf::RootGetElectNodesResponse* Arena::CreateMaybeMessage<::top::kadmlia::protobuf::RootGetElectNodesResponse>(Arena*);
...
class RootGetElectNodesRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:top.kadmlia.protobuf.RootGetElectNodesRequest) */ {
 public:
  RootGetElectNodesRequest();
  virtual ~RootGetElectNodesRequest();

  RootGetElectNodesRequest(const RootGetElectNodesRequest& from);

  inline RootGetElectNodesRequest& operator=(const RootGetElectNodesRequest& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  RootGetElectNodesRequest(RootGetElectNodesRequest&& from) noexcept
    : RootGetElectNodesRequest() {
    *this = ::std::move(from);
  }

  inline RootGetElectNodesRequest& operator=(RootGetElectNodesRequest&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const RootGetElectNodesRequest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const RootGetElectNodesRequest* internal_default_instance() {
    return reinterpret_cast<const RootGetElectNodesRequest*>(
               &_RootGetElectNodesRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    37;

  void Swap(RootGetElectNodesRequest* other);
  friend void swap(RootGetElectNodesRequest& a, RootGetElectNodesRequest& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline RootGetElectNodesRequest* New() const final {
    return CreateMaybeMessage<RootGetElectNodesRequest>(NULL);
  }

  RootGetElectNodesRequest* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<RootGetElectNodesRequest>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const RootGetElectNodesRequest& from);
  void MergeFrom(const RootGetElectNodesRequest& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RootGetElectNodesRequest* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:top.kadmlia.protobuf.RootGetElectNodesRequest)
 private:
...
class RootGetElectNodesResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:top.kadmlia.protobuf.RootGetElectNodesResponse) */ {
 public:
  RootGetElectNodesResponse();
  virtual ~RootGetElectNodesResponse();

  RootGetElectNodesResponse(const RootGetElectNodesResponse& from);

  inline RootGetElectNodesResponse& operator=(const RootGetElectNodesResponse& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  RootGetElectNodesResponse(RootGetElectNodesResponse&& from) noexcept
    : RootGetElectNodesResponse() {
    *this = ::std::move(from);
  }

  inline RootGetElectNodesResponse& operator=(RootGetElectNodesResponse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const RootGetElectNodesResponse& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const RootGetElectNodesResponse* internal_default_instance() {
    return reinterpret_cast<const RootGetElectNodesResponse*>(
               &_RootGetElectNodesResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    38;

  void Swap(RootGetElectNodesResponse* other);
  friend void swap(RootGetElectNodesResponse& a, RootGetElectNodesResponse& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline RootGetElectNodesResponse* New() const final {
    return CreateMaybeMessage<RootGetElectNodesResponse>(NULL);
  }

  RootGetElectNodesResponse* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<RootGetElectNodesResponse>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const RootGetElectNodesResponse& from);
  void MergeFrom(const RootGetElectNodesResponse& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RootGetElectNodesResponse* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:top.kadmlia.protobuf.RootGetElectNodesResponse)
 private:
...
// optional uint64 des_service_type = 1;
inline bool RootGetElectNodesRequest::has_des_service_type() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void RootGetElectNodesRequest::set_has_des_service_type() {
  _has_bits_[0] |= 0x00000001u;
}
inline void RootGetElectNodesRequest::clear_has_des_service_type() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void RootGetElectNodesRequest::clear_des_service_type() {
  des_service_type_ = GOOGLE_ULONGLONG(0);
  clear_has_des_service_type();
}
inline ::google::protobuf::uint64 RootGetElectNodesRequest::des_service_type() const {
  // @@protoc_insertion_point(field_get:top.kadmlia.protobuf.RootGetElectNodesRequest.des_service_type)
  return des_service_type_;
}
inline void RootGetElectNodesRequest::set_des_service_type(::google::protobuf::uint64 value) {
  set_has_des_service_type();
  des_service_type_ = value;
  // @@protoc_insertion_point(field_set:top.kadmlia.protobuf.RootGetElectNodesRequest.des_service_type)
}

// optional uint32 count = 2;
inline bool RootGetElectNodesRequest::has_count() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void RootGetElectNodesRequest::set_has_count() {
  _has_bits_[0] |= 0x00000002u;
}
inline void RootGetElectNodesRequest::clear_has_count() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void RootGetElectNodesRequest::clear_count() {
  count_ = 0u;
  clear_has_count();
}
inline ::google::protobuf::uint32 RootGetElectNodesRequest::count() const {
  // @@protoc_insertion_point(field_get:top.kadmlia.protobuf.RootGetElectNodesRequest.count)
  return count_;
}
inline void RootGetElectNodesRequest::set_count(::google::protobuf::uint32 value) {
  set_has_count();
  count_ = value;
  // @@protoc_insertion_point(field_set:top.kadmlia.protobuf.RootGetElectNodesRequest.count)
}
...
// repeated .top.kadmlia.protobuf.NodeInfo nodes = 1;
inline int RootGetElectNodesResponse::nodes_size() const {
  return nodes_.size();
}
inline void RootGetElectNodesResponse::clear_nodes() {
  nodes_.Clear();
}
inline ::top::kadmlia::protobuf::NodeInfo* RootGetElectNodesResponse::mutable_nodes(int index) {
  // @@protoc_insertion_point(field_mutable:top.kadmlia.protobuf.RootGetElectNodesResponse.nodes)
  return nodes_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::top::kadmlia::protobuf::NodeInfo >*
RootGetElectNodesResponse::mutable_nodes() {
  // @@protoc_insertion_point(field_mutable_list:top.kadmlia.protobuf.RootGetElectNodesResponse.nodes)
  return &nodes_;
}
inline const ::top::kadmlia::protobuf::NodeInfo& RootGetElectNodesResponse::nodes(int index) const {
  // @@protoc_insertion_point(field_get:top.kadmlia.protobuf.RootGetElectNodesResponse.nodes)
  return nodes_.Get(index);
}
inline ::top::kadmlia::protobuf::NodeInfo* RootGetElectNodesResponse::add_nodes() {
  // @@protoc_insertion_point(field_add:top.kadmlia.protobuf.RootGetElectNodesResponse.nodes)
  return nodes_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::top::kadmlia::protobuf::NodeInfo >&
RootGetElectNodesResponse::nodes() const {
  // @@protoc_insertion_point(field_list:top.kadmlia.protobuf.RootGetElectNodesResponse.nodes)
  return nodes_;
}
