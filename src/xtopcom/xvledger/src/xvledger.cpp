...
namespace top
{
    namespace base
    {
        ...
        {
            xdbg_info("xvtable_t::monitor_plugin account=%s,plugin type(%d)",plugin_obj->get_account().c_str() ,plugin_obj->get_plugin_type());
        ...
        {
            xdbg_info("xvtable_t::monitor_account account=%s,account_obj=%p",account_obj->get_account().c_str());
            //push to monitor queue
            {
