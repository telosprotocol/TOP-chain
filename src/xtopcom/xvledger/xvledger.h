    ...
    namespace base
    {
        ...
        */
        ...
        enum enum_xvaccount_config
        {
            ...
            enum_block_plugin_idle_timeout_ms   = 5*60*1000,  //idle duration for plugin
            enum_state_plugin_idle_timeout_ms   = 5*60*1000,  //idle duration for plugin
#else
            enum_account_idle_timeout_ms        = 300*60*1000, //account change to idle status if not access within 300 minutes
            enum_block_plugin_idle_timeout_ms   = 60*60*1000,  //idle duration for plugin  60minutes
            enum_state_plugin_idle_timeout_ms   = 120*60*1000,  //idle duration for plugin  120minutes
#endif
