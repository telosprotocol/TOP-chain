...
namespace top
{
    namespace base
    {
        ...
        public: //write interface that generated instructions only
        ...
        protected: //write interface that generated & record instructions as well
            bool                clear_value(); //reset all value to logic'zero
            bool                reset_value(const xvalue_t & new_value);//reset and replace by new_value
        ...
        private: //internal instruction functions
            const xvalue_t  do_clear_value(const xvmethod_t & op);
            const xvalue_t  do_reset_value(const xvmethod_t & op);
            const xvalue_t  do_clone_value(const xvmethod_t & op);
        private:
        ...
        public: //write interface
            bool  clear(); //erase to empty string
        ...
        public: //write interface
            ...
            bool  clear(); //erase all key and values
