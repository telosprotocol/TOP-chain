...
xcons_service_mgr_ptr xcons_mgr_build(std::string const & node_account,
    ...
    // global lifecyle
    auto p_res = new xunit_service::xresources(node_account, work_pool, xbft_work_pool, certauth, blockstore, network, pelection, tx_timer, accessor, mbus, txpool, state_syncer);
