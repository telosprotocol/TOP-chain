...
{
    bool operator()(const base::xtableid_t& ti_lhs, const base::xtableid_t& ti_rhs) const
    {
...
public:
    // load manager tables
    virtual int32_t get_tables(const xvip2_t & xip, std::vector<base::xtableid_t> * tables) = 0;
