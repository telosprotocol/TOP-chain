...
class xstatestore_impl_t : public xstatestore_face_t {
 ...
 public:
    ...
    virtual xtablestate_ext_ptr_t do_commit_table_all_states(base::xvblock_t* current_block, xtablestate_store_ptr_t const& tablestate_store, std::vector<statectx::xunitstate_ctx_ptr_t> const& unitctxs, std::error_code & ec) const override;
