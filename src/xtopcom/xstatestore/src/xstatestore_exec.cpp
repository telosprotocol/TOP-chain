...
xtablestate_ext_ptr_t xstatestore_executor_t::write_table_all_states(base::xvblock_t* current_block, xtablestate_store_ptr_t const& tablestate_store, std::error_code & ec) const {
    ...
    xinfo("xstatestore_executor_t::write_table_all_states tps_key serialize states,block:%s,kvs=%zu,count=%d",current_block->dump().c_str(), unitstate_db_kvs.size(),count);
    ...
    xinfo("xstatestore_executor_t::write_table_all_states tps_key write db states,block:%s",current_block->dump().c_str());
    ...
    xinfo("xstatestore_executor_t::write_table_all_states tps_key after create,block:%s",current_block->dump().c_str());
