...
class xstatestore_dbaccess_t {
 ...
 public:
    ...
    data::xunitstate_ptr_t      read_fullunit_bstate(common::xaccount_address_t const& address, uint64_t height, const std::string & block_hash) const;
...
private:
    ...
    xunitstate_cache_ptr_t      m_unitstate_cache;
